...
class solopine_latest_news_widget extends WP_Widget {
	...
	function solopine_latest_news_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'solopine_latest_news_widget', 'description' => __('A widget that displays your latest posts from all categories or a certain', 'solopine_latest_news_widget') );
